...
// TODO: Refactor edufarm.service.ValidationResponseService into ViewModels

/**
 * 예약/문의({@link edufarm.model.Reservation}) REST API. /api/reservation
...
public class ReservationRestController {
    ...
    /**
     * 새로운 예약({@link edufarm.model.Reservation}).
     * <p>JSON String으로 인코딩 된 {@link edufarm.model.Reservation}을 받는다(HTTP POST).
     *
     * @param reservation
     * @param result
     * @param principal
    ...
    public ValidationResponse submitReservation(@Valid @RequestBody Reservation reservation, BindingResult result, Principal principal) throws IOException, NoSuchAlgorithmException {
        ...
        sms.setMessage("[수우원 에듀팜] http://edu.soowoowon.com/reservation/detail/" + reservation.getId());
    ...
    /**
     * 예약({@link edufarm.model.Reservation})의 변경.
     * <p>JSON String으로 인코딩 된 {@link edufarm.model.Reservation}을 받는다(HTTP POST).
     *
     * @param id
    ...
    /**
     * 예약({@link edufarm.model.Reservation})의 삭제.
    ...
    /**
     * 예약({@link edufarm.model.Reservation})의 상태({@link edufarm.model.Reservation#articleState}) 변경.
     *
     * @param id
     * @param state
     */
    ...
    /**
     * 예약({@link edufarm.model.Reservation})에 댓글({@link edufarm.model.Comment}) 추가.
    ...
    /**
     * 예약({@link edufarm.model.Reservation})의 댓글({@link edufarm.model.Comment} 삭제.
     * <p>HTTP DELETE 또는 HTTP POST의 숨겨진 필드(_method: "DELETE")로 접근 가능.
     *
     * @param commentId
     */
