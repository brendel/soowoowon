 ...
 * {@link edufarm.model.Article}로는 올바르게 폼데이터를 바인딩할 수 없다.
 * 하나의 {@link edufarm.model.Article}는 여러 번의 multipart/form-data 요청과 본문인 articleForm을 POST 요청으로 나눠서 받은 다음,
 * {@link ArticleService#add(Article, ArticleForm)}를 통해 하나의 {@link edufarm.model.Article}로 저장된다.
 *
