...
import edufarm.viewModel.ChangePasswordForm;
import edufarm.viewModel.EditUserForm;
...
/**
 * 회원({@link edufarm.model.User})정보의 수정, 패스워드 변경.
 *
...
public class UserInformationRestController {
    ...
    /**
     * 회원({@link edufarm.model.User}) 닉네임, 전화번호 변경(HTTP POST).
    ...
    /**
     * 회원({@link edufarm.model.User}) 비밀번호 변경(HTTP POST).
