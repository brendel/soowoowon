...
/**
 * 하나의 댓글을 나타내는 클래스.
 * <p>같은 이름의 DB 테이블(Comment)과 맵핑된다. {@link com.soowoowon.model.User}와 N:1 연관을 가지며,
 * {@link com.soowoowon.model.Article}과 조인테이블 "Article_Comment"를 통해 선택적 N:1 연관을 가진다.
 *
