                ...
                <div class="row">
                    <div class="col-md-12 col-sm12 col-xs-12 form-group">
                        ...
                        <input type="text" name="title" class="form-control input-lg" id="article-title"
                               ...
                               autofocus="true" value="<c:out value="${article.title}"/>" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 col-sm12 col-xs-12 form-group">
                        ...
                        <textarea name="content" class="form-control input-lg" id="article-content"
                                  ...
                                  rows="10" required><c:out value="${article.content}"/></textarea>
                    </div>
                </div>
            </form>
            <form id="fileupload" method="POST"
                ...
                <div class="row">
                    <div class="col-md-12 col-sm12 col-xs-12">
                        <ul id="uploaded-photos" class="list-group files">
                            <c:forEach var="photo" items="${article.photos}">
                                <li class="list-group-item template-download fade in">
                                    <div class="row">
                                        <div class="col-md-2 col-sm-2 col-xs-3">
                                            <span class="preview">
                                                    <a href="${photo.uri}" title="${photo.fileName}"
                                                       download="${photo.fileName}" data-gallery><img width="80px"
                                                                                                      height="80px"
                                                                                                      class="img-responsive img-rounded"
                                                                                                      src="${photo.thumbnailUri}"></a>
                                            </span>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-4">
                                            <p class="name">
                                                <a href="${photo.uri}" title="${photo.fileName}"
                                                   download="${photo.fileName}" data-gallery>
                                                    <small>${photo.fileName}</small>
                                                </a>
                                            </p>
                                        </div>
                                        <div class="col-md-2 col-sm-2 col-xs-2 text-right">
                                            <small><span class="size"></span></small>
                                        </div>
                                        <div class="col-md-2 col-sm-2 col-xs-3 text-right">
                                            <button class="btn btn-sm btn-danger delete" data-photoId="${photo.id}"
                                                    data-type="DELETE" data-url="/api/photo/${photo.id}">
