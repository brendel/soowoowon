...
import edufarm.model.Enum.ArticleState;
 ...
 * <p>같은 이름의 DB 테이블(Article)과 맵핑된다. {@link edufarm.model.User}와 N:1 연관을 가지며,
 * {@link edufarm.model.Comment}와 선택적 1:N 연관을 가진다.
 *
