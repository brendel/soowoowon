...
import edufarm.excelView.ReservationExcelView;
import edufarm.model.Article;
import edufarm.model.User;
import edufarm.service.*;
...
public class AdminController {
    ...
    /**
     * 관리자 영역의 첫 페이지.
     * <p>{@link edufarm.service.StatService}에서 방문자 IP, OS, 웹브라우저, 리퍼러 통계등을 가져와서 뷰에 넘겨준다.
     *
     * @param model
     * @return
     */
    ...
    /**
     * 사이트 첫 페이지 수정 페이지.
     * <p>사이트 첫 페이지는 가장 최신의 {@link edufarm.model.Article}이다.
     *
     * @param model
     * @return
     */
     ...
     * @param model
     * @return
     * @see edufarm.excelView.ReservationExcelView
     */
